...
import { BANNER_DATA } from '../../constants/constants';
  ...
  return (
    <BannerLayout>
      <div className='absolute inset-0 z-20 flex flex-col items-center py-6 justify-center w-full h-full bg-gradient-to-t from-MidNightBlack'>
                  ...
                  <span>
                    ...
                    <span className='text-Snow sm:text-xl xl:text-2xl font-bold'>
                      ...
                      <span className='inline-block'>
                        <Typewriter
                          options={{
                            strings: BANNER_DATA.BANNER_TYPEWRITER,
                            autoStart: true,
                            loop: true,
                          }}
                        />
        ...
        {/* details in row */}
        <div className='grid grid-cols-2 gap-4 md:gap-0 mt-2 md:flex items-center justify-between w-full px-4 xl:px-8 2xl:px-16'>
          <div className='flex items-center gap-x-1'>
            <span className='text-base md:text-lg text-Green font-bold'>{BANNER_DATA.COMPLETED_PROJECTS}</span>
            <span className='text-xs text-Snow'>Completed Projects</span>
          </div>

          <div className='flex items-center gap-x-1'>
            <span className='text-base md:text-lg text-Green font-bold'>{BANNER_DATA.FREELANCE_CLIENTS}</span>
            <span className='text-xs text-Snow'>Freelance Clients</span>
          </div>

          <div className='flex items-center gap-x-1'>
            <span className='text-base md:text-lg text-Green font-bold'>{BANNER_DATA.HONORS_AND_AWARDS}</span>
            <span className='text-xs text-Snow'>Honors & Awards</span>
          </div>

          <div className='flex items-center gap-x-1'>
            <span className='text-base md:text-lg text-Green font-bold'>{BANNER_DATA.OPEN_SOURCE_CONTRIBUTION}</span>
